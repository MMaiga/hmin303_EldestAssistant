...
describe('#/api/users', function(){
  ...
  it.skip('- should GET users', function(done){
    request(app)
      .get('/api/users')
  ...
  it.skip('- should GET a user at index (1)', function(done){
    request(app)
      .get('/api/users/1')
      .end(function(err, res){
  ...
  it.skip('- should POST a user and get back a response', function(done){
    var user = {
      name: 'Steve Wozniak'
    };
