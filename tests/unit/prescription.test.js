...
describe('#/api/prescription', function(){
	...
	it('- should get a not empty list', function(done){
		request(app)
	...
	it('- should get a list of prescription', function(done){
		request(app)
		.get('/api/prescription')
		.expect(200)
		.expect('Content-Type', /json/)
	...
	it('- should get a all prescription from database', function(done){
		request(app)
		.get('/api/prescription')
		.expect(200)
		.expect('Content-Type', /json/)
...
describe('#/api/prescription/create', function(){
	...
	it('- should create a prescription', function(done){
		request(app)
	...
	it('- should FAILED to create a prescription', function(done){
		request(app)
		.post('/api/prescription/create')
		.send(
		{
...
describe('#/api/prescription/read', function(){
	...
	it('- should read prescription (prescription exist)', function(done){
		request(app)
	...
	it('- should return an error (prescription not exist)', function(done){
		request(app)
...
describe('#/api/prescription/update', function(){
		...
		it('- should update a prescription', function(done){
			request(app)
		...
		it('- should FAILED to update a prescription', function(done){
			request(app)
			.post('/api/prescription/update')
			.send(
			{
...
describe('#/api/prescription/delete', function(){
 ...
 async.series([
	...
	it('- should delete prescription', function(done){
		request(app)
